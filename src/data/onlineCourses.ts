...
export const onlineCourses: OnlineCourse[] = [
  {
    id: 'oc-1',
    university: 'Dr. D. Y. Patil Vidyapeeth, Pune (Deemed To Be University)',
  ...
  {
    id: 'oc-3',
    university: 'Symbiosis School For Online And Digital Learning (SSODL)',
    degree: 'Online MBA Programme',
    duration: '24 Months | 2 Year Program',
    rating: '4/5',
    logo: 'Symbiosis',
  ...
  {
    id: 'oc-5',
    university: 'Dr. D. Y. Patil Vidyapeeth Centre For Online Learning (DPU-COL)',
...
export const onlineFaqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: 'Accredited online universities in India are recognized by UGC-DEB (Distance Education Bureau) and carry NAAC ratings. We partner strictly with premium A++ accredited institutions including Manipal, Symbiosis, Amity, and LPU.'
  },
  {
